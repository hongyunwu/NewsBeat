 ...
 */
public class TiYuViewAdapter extends RecyclerView.Adapter<TiYuItemViewHolder> {


	public static final int ITEM_TYPE_THUMB1 = 1;
	public static final int ITEM_TYPE_THUMB3 = 2;

	private List<TiYuBean.ResultBean.DataBean> mData;
	private Context mContext;

	public TiYuViewAdapter(Context context, List<TiYuBean.ResultBean.DataBean> data) {
	...
	@Override
	public TiYuItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
		int layoutId = 0;
		...
		final TiYuItemViewHolder tiYuItemViewHolder = new TiYuItemViewHolder(LayoutInflater.from(mContext).inflate(layoutId, parent, false));
		tiYuItemViewHolder.setListeners(new View.OnClickListener() {
			@Override
	...
	@Override
	public void onBindViewHolder(TiYuItemViewHolder holder, int position) {
		TiYuBean.ResultBean.DataBean dataBean = mData.get(position);
	...
	public interface OnItemClickListener{
		...
		void onItemClick(int position, TiYuBean.ResultBean.DataBean dataBean);
	}
}
