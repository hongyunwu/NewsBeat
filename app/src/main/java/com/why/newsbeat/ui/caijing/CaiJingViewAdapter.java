 ...
 */
public class CaiJingViewAdapter extends RecyclerView.Adapter<CaiJingItemViewHolder> {


	public static final int ITEM_TYPE_THUMB1 = 1;
	public static final int ITEM_TYPE_THUMB3 = 2;

	private List<CaiJingBean.ResultBean.DataBean> mData;
	private Context mContext;

	public CaiJingViewAdapter(Context context, List<CaiJingBean.ResultBean.DataBean> data) {
	...
	@Override
	public CaiJingItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
		int layoutId = 0;
		...
		final CaiJingItemViewHolder caiJingItemViewHolder = new CaiJingItemViewHolder(LayoutInflater.from(mContext).inflate(layoutId, parent, false));
		caiJingItemViewHolder.setListeners(new View.OnClickListener() {
			@Override
	...
	@Override
	public void onBindViewHolder(CaiJingItemViewHolder holder, int position) {
		CaiJingBean.ResultBean.DataBean dataBean = mData.get(position);
