 ...
 */
public class KeJiViewAdapter extends RecyclerView.Adapter<KeJiItemViewHolder> {


	public static final int ITEM_TYPE_THUMB1 = 1;
	public static final int ITEM_TYPE_THUMB3 = 2;

	private List<KeJiBean.ResultBean.DataBean> mData;
	private Context mContext;

	public KeJiViewAdapter(Context context, List<KeJiBean.ResultBean.DataBean> data) {
	...
	@Override
	public KeJiItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
		int layoutId = 0;
		...
		final KeJiItemViewHolder keJiItemViewHolder = new KeJiItemViewHolder(LayoutInflater.from(mContext).inflate(layoutId, parent, false));
		keJiItemViewHolder.setListeners(new View.OnClickListener() {
			@Override
	...
	@Override
	public void onBindViewHolder(KeJiItemViewHolder holder, int position) {
		KeJiBean.ResultBean.DataBean dataBean = mData.get(position);
	...
	public interface OnItemClickListener{
		...
		void onItemClick(int position, KeJiBean.ResultBean.DataBean dataBean);
	}
}
