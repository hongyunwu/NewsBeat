 ...
 */
public class SheHuiViewAdapter extends RecyclerView.Adapter<SheHuiItemViewHolder> {


	public static final int ITEM_TYPE_THUMB1 = 1;
	public static final int ITEM_TYPE_THUMB3 = 2;

	private List<SheHuiBean.ResultBean.DataBean> mData;
	private Context mContext;

	public SheHuiViewAdapter(Context context, List<SheHuiBean.ResultBean.DataBean> data) {
		this.mContext = context;
		this.mData = data;
	}
	public void setData(@NonNull List<SheHuiBean.ResultBean.DataBean> data) {
		this.mData = data;

	}
	public void addData(@NonNull List<SheHuiBean.ResultBean.DataBean> data){
		if (mData==null){
			mData = data;
		}else {
			mData.addAll(data);
	...
	public int getItemViewType(int position) {
		SheHuiBean.ResultBean.DataBean dataBean = mData.get(position);
	...
	@Override
	public SheHuiItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
		int layoutId = 0;
		...
		final SheHuiItemViewHolder sheHuiItemViewHolder = new SheHuiItemViewHolder(LayoutInflater.from(mContext).inflate(layoutId, parent, false));
		sheHuiItemViewHolder.setListeners(new View.OnClickListener() {
			@Override
	...
	@Override
	public void onBindViewHolder(SheHuiItemViewHolder holder, int position) {
		SheHuiBean.ResultBean.DataBean dataBean = mData.get(position);
	...
	public interface OnItemClickListener{
		...
		void onItemClick(int position, SheHuiBean.ResultBean.DataBean dataBean);
	}
}
