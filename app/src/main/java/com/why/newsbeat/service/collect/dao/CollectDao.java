...
*/
public class CollectDao extends AbstractDao<Collect, Void> {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COLLECT\" (" + //
                "\"UNIQUEKEY\" TEXT UNIQUE ," + // 0: uniquekey
                "\"TITLE\" TEXT," + // 1: title
                "\"DATE\" TEXT," + // 2: date
    ...
    @Override
    protected final Void updateKeyAfterInsert(Collect entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(Collect entity) {
        return null;
    }
